...
import { getComponentByName, components } from "@/lib/registry-data";
...
import { categoryLabels } from "@/lib/registry-data";
...
export async function generateMetadata({ params }: PageProps) {
  ...
  if (!comp) return {};
  return { title: `${comp.title} — daigo/ui` };
}
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-8">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold tracking-tight mb-1.5">{comp.title}</h1>
            ...
            <table className="w-full text-xs border-collapse">
              <thead>
                <tr className="bg-muted/40 border-b border-border/60">
                  ...
                  <th className="px-2 py-2 text-left font-medium text-muted-foreground/70 w-[120px]">名前</th>
                  <th className="px-3 py-2 text-left font-medium text-muted-foreground/70">型</th>
                  <th className="px-3 py-2 text-left font-medium text-muted-foreground/70 w-[110px]">デフォルト</th>
                  <th className="px-3 py-2 text-left font-medium text-muted-foreground/70">説明</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  return (
                    <tr
                      ...
                      className={[
                        ...
                        i < comp.props.length - 1 ? "border-b border-border/40" : "",
                      ].join(" ")}
                    >
                      {/* バッジ */}
